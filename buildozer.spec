...
package.domain = com.github.r19988088

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (let empty to include all the files)
source.include_exts = py,png,jpg,kv,atlas,ttf,ogg,mp3,wav,tja
...
# (str) Custom repository to search for requirements
#requirements.source = 
...
# for example android.add_packaging_options = maxNumberOfXXZipEntries=10000
